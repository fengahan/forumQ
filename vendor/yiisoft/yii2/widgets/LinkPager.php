...
class LinkPager extends Widget
{
    ...
    protected function renderPageButtons()
    {
        ...
        /****增加总页数***/
        $buttons[] = Html::tag('li', Html::tag("span", $this->pagination->getPageCount().'页'), ['class'=>$this->linkOptions['class']]);
        /****增加总条数***/
        $buttons[] = Html::tag('li', Html::tag("span", $this->pagination->totalCount.'条'), ['class'=>$this->linkOptions['class']]);
